...
function renderList(source2, renderItem, cache, index) {
  ...
  if (sourceIsArray || isString$1(source2)) {
    ...
    for (let i = 0, l = source2.length; i < l; i++) {
      ret[i] = renderItem(
        needsWrap ? toReactive(source2[i]) : source2[i],
        i,
        void 0,
        cached && cached[i]
      );
...
const fetchAll = () => Promise.all([fetchStaff(), fetchDepartments()]);
const staffMemberOfDepartment = (departmentId, field) => {
  var _a;
  const department = departments.data.find((x) => x.id == departmentId);
  const staffMemberId = (_a = department == null ? void 0 : department.fields) == null ? void 0 : _a[field][0];
  return staff.data.find((x) => x.id == staffMemberId) || null;
};
const departmentsOfStaffMember = (staffMemberId) => {
  var _a, _b;
  const staffMember = staff.data.find((x) => x.id == staffMemberId);
  const PRSAssignments = ((_a = staffMember == null ? void 0 : staffMember.fields) == null ? void 0 : _a.PRSAssignments) || [];
  const MRSAssignments = ((_b = staffMember == null ? void 0 : staffMember.fields) == null ? void 0 : _b.MRSAssignments) || [];
  const departmentIds = /* @__PURE__ */ new Set([...PRSAssignments, ...MRSAssignments]);
    ...
    detectSelection() {
      ...
      if (this.departmentInputId) {
        changeValue(
          ...
          ((_b = (_a = this.selectedDepartment) == null ? void 0 : _a.fields) == null ? void 0 : _b.Name) || null
        );
      }
      if (this.prsEmailInputId) {
        changeValue(
          document.getElementById(this.prsEmailInputId),
          ((_d = (_c = staffMemberOfDepartment(this.selectedDepartmentId, "PRS")) == null ? void 0 : _c.fields) == null ? void 0 : _d.Email) || null
        );
      }
      if (this.mrsEmailInputId) {
        changeValue(
          document.getElementById(this.mrsEmailInputId),
          ((_f = (_e = staffMemberOfDepartment(this.selectedDepartmentId, "MRS")) == null ? void 0 : _e.fields) == null ? void 0 : _f.Email) || null
        );
      }
    }
  }
...
const _hoisted_2$1 = { class: "fsLabel fsRequiredLabel" };
const _hoisted_3$1 = {
  key: 0,
  class: "fsRequiredMarker"
};
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    createBaseVNode("label", _hoisted_2$1, [
      ...
      $props.required ? (openBlock(), createElementBlock("span", _hoisted_3$1, "*")) : createCommentVNode("", true)
    ]),
    withDirectives(createBaseVNode("select", {
      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.selectedDepartmentId = $event),
      onChange: _cache[1] || (_cache[1] = (...args) => $options.detectSelection && $options.detectSelection(...args)),
      class: normalizeClass($props.selectClass)
    }, [
      _cache[2] || (_cache[2] = createBaseVNode("option", { value: null }, null, -1)),
      (openBlock(true), createElementBlock(Fragment, null, renderList($setup.departments.data, ({ id, fields: department }) => {
        return openBlock(), createElementBlock("option", {
          value: id,
          key: id
        }, toDisplayString(department.Name), 9, _hoisted_4$1);
      }), 128))
    ], 34), [
      [vModelSelect, _ctx.selectedDepartmentId]
    ])
  ]);
}
var SelectFieldComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
const _sfc_main = {
  props: {
    filter: {
      type: String,
  ...
  computed: {
    filteredStaff() {
      return this.filter ? staff.data.filter((x) => {
        var _a;
        return ((_a = x.fields) == null ? void 0 : _a.Filter) == this.filter;
      }) : staff.data;
    }
  }
};
  ...
  return openBlock(), createElementBlock("table", _hoisted_1, [
    _cache[6] || (_cache[6] = createBaseVNode("thead", null, [
      createBaseVNode("tr", null, [
        createBaseVNode("th", null, "Name & Responsibilities"),
        createBaseVNode("th", null, "Contact Information")
      ])
    ], -1)),
    $setup.staff ? (openBlock(), createElementBlock("tbody", _hoisted_2, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($options.filteredStaff, ({ id, fields: person }) => {
        return openBlock(), createElementBlock("tr", { key: id }, [
          createBaseVNode("td", null, [
            createBaseVNode("h4", null, [
              createTextVNode(toDisplayString(person.Name) + " ", 1),
              createBaseVNode("small", _hoisted_3, [
                _cache[0] || (_cache[0] = createBaseVNode("br", null, null, -1)),
                createTextVNode(" " + toDisplayString(person.Title), 1)
              ])
            ]),
            $setup.departmentsOfStaffMember(id).length ? (openBlock(), createElementBlock("ul", _hoisted_4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.departmentsOfStaffMember(
                id
              ), ({ deptId, fields: department }) => {
                return openBlock(), createElementBlock("li", { key: deptId }, toDisplayString(department.Name), 1);
              }), 128))
            ])) : createCommentVNode("", true),
            person.OOO ? (openBlock(), createElementBlock("em", _hoisted_5, [
              _cache[1] || (_cache[1] = createBaseVNode("strong", null, "Out of Office Backup:", -1)),
              createTextVNode(" " + toDisplayString(person.OOOBackupName), 1)
            ])) : createCommentVNode("", true)
          ]),
          createBaseVNode("td", null, [
            ...
            $props.showVoip ? (openBlock(), createElementBlock("div", _hoisted_8, [
              _cache[3] || (_cache[3] = createBaseVNode("span", {
                class: "fa fa-fw fa-phone-square",
                "aria-label": "VOIP Phone"
              }, null, -1)),
              createTextVNode(" " + toDisplayString(person.VOIP), 1)
            ])) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_9, [
              ...
              createBaseVNode("a", {
                href: `tel:${person.OfficePhone}`
              }, toDisplayString(person.OfficePhone), 9, _hoisted_10)
            ]),
            createBaseVNode("div", _hoisted_11, [
              ...
              }, toDisplayString(person.MobilePhone), 9, _hoisted_12)
            ])
          ])
        ]);
      }), 128))
...
var StaffTableComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
fetchAll();
trackWithLoggly();
const SelectField = (props = {}) => createApp(SelectFieldComponent, props);
const StaffTable = (props = {}) => createApp(StaffTableComponent, props);
export { SelectField, StaffTable };
